# SWU-PGN/1.0 Spec + Reference Reader Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build the normative SWU-PGN/1.0 specification, its JSON Schemas, a set of canonical test vectors, and an engine-independent TypeScript reference reader (`parse`/`fold`/`render`/`validate`) that passes the vectors.
...
- `docs/SWU-PGN-1.0-SPEC.md` — the normative specification (replaces `docs/SWU-PGN-FORMAT.md` as the canonical spec; old file kept until Plan 2 lands).
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://karabast.net/swu-pgn/1.0/deck.schema.json",
  "type": "object",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://karabast.net/swu-pgn/1.0/annotation.schema.json",
  "type": "object",
  "required": ["ref"],
  "properties": {
    "ref": { "type": "string" },
...
**Files:**
- Create: `docs/SWU-PGN-1.0-SPEC.md`

- [ ] **Step 1: Write the spec document**

Author `docs/SWU-PGN-1.0-SPEC.md` with this exact section structure (RFC/W3C style). Each section's content is dictated by the already-implemented module, so it is descriptive, not inventive:

```markdown
# SWU-PGN/1.0 Specification
...
```bash
git add docs/SWU-PGN-1.0-SPEC.md
git commit -m "docs: SWU-PGN/1.0 normative specification"
```
