...
| `npm run test-parallel` (reporter-based, exact case identities) | 8573 specs: 8560 passed, 13 pending (unchanged identities), 0 failed - baseline's 8504 passing + this unit's 56 new cases |
| `npm run test-parallel-undo` (reporter-based, exact case identities) | 8385 specs: 8368 passed, 17 pending (unchanged identities), 0 failed - baseline's 8312 passing + this unit's 56 new cases |
