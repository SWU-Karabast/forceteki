...
Formatting patterns, naming rules, and common setup bloat found across spec files.
...
- For leader cards, use `'his/her triggered deploy ability'` for the undeployed leader side trigger that deploys the leader
