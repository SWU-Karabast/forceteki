...
Before writing any code, read the repo's `CLAUDE.md` (auto-loaded from the project root) and `.claude/reference/forceteki-dev-guide.md` in full. Together these are your primary reference for:
