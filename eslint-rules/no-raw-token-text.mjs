...
const TOKEN_CATEGORIES = [
    ...
    },
    {
        ...
        names: [
            ...
            // bases traits
            'Aldhani', 'Atollon', 'Bracca', 'Cantonica', 'Castilon', 'Christophsis', 'CloudCity', 'Concordia',
            ...
            'ObaDiah', 'Onderon', 'Peridea', 'Pillio', 'Quarzite', 'Ryloth', 'Scarif', 'Seatos', 'Segra Milo',
            'Serenno', 'Sorgan', 'Starkiller Base', 'Starlight Beacon', 'StygeonPrime', 'Takodana', 'Tatooine',
