...
export = {
    ...
    provideAspects: (properties: Omit<IProvideAspectsCostAdjusterProperties, 'costAdjustType'>) => modifyCost({ costAdjustType: CostAdjustType.ProvideAspects, ...properties }),
