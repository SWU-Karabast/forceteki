...
export default class AidFromTheInnocent extends EventCard {
    ...
    public override setupCardAbilities(registrar: IEventAbilityRegistrar, AbilityHelper: IAbilityHelper) {
        registrar.setEventAbility({
            title: `Search the top 10 cards of your deck for 2 ${TextHelper.aspect(Aspect.Heroism)} non-unit cards and discard them. For this phase, you may play the discarded cards, and they each cost 2 less.`,
