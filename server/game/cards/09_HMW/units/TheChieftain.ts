...
export default class TheChieftain extends NonLeaderUnitCard {
    ...
    public override setupCardAbilities(registrar: INonLeaderUnitAbilityRegistrar, AbilityHelper: IAbilityHelper) {
        registrar.addConstantAbility({
            title: `This unit gains ${TextHelper.keyword({ keyword: KeywordName.Raid, amount: 1 })} for each other friendly ${TextHelper.Trait.Tusken} unit`,
        ...
        registrar.addConstantAbility({
            ...
            matchTarget: (card) => card.isUnit() && card.isInPlay() && card.hasSomeTrait(Trait.Tusken) && card.isDefending(),
