...
export default class LeiaOrganaExtraordinary extends NonLeaderUnitCard {
    ...
    public override setupCardAbilities(registrar: INonLeaderUnitAbilityRegistrar, AbilityHelper: IAbilityHelper) {
        registrar.addConstantAbility({
            title: `While this unit is in the space arena, she can't ready and gains "Action [use the Force]: Move this unit to the ground arena and give each friendly ${TextHelper.aspects(Aspect.Heroism)} unit +2/+2 for this phase"`,
            ...
            ongoingEffect: [
                ...
                AbilityHelper.ongoingEffects.gainAbility({
                    title: `Move this unit to the ground arena and give each friendly ${TextHelper.aspects(Aspect.Heroism)} unit +2/+2 for this phase`,
