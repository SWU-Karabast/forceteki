...
export default class WithThunderousApplause extends EventCard {
    ...
    public override setupCardAbilities (registrar: IEventAbilityRegistrar, abilityHelper: IAbilityHelper) {
        ...
        registrar.setEventAbility({
            title: `Give a unit +2/+2 for this phase. You may disclose ${EnumHelpers.aspectString(aspects)}. If you do, give another unit +2/+2 for this phase`,
            targetResolver: {
            ...
            then: (thenContext) => ({
                title: `Disclose ${EnumHelpers.aspectString(aspects)} to give another unit +2/+2 for this phase`,
