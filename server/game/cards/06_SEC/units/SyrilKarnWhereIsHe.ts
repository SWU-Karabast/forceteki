...
export default class SyrilKarnWhereIsHe extends NonLeaderUnitCard {
    ...
    public override setupCardAbilities (registrar: INonLeaderUnitAbilityRegistrar, abilityHelper: IAbilityHelper) {
        ...
        registrar.addOnAttackAbility({
            title: TextHelper.performReplacements(`Disclose ${TextHelper.aspectList(aspects)} to choose a unit. Deal 2 damage to that unit unless its controller discards a card from their hand`),
