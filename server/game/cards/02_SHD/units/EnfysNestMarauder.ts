...
export default class EnfysNestMarauder extends NonLeaderUnitCard {
    ...
    public override setupCardAbilities () {
        this.addConstantAbility({
            ...
            matchTarget: (card, context) => card.isUnit() && card.isInPlay() && card.isDefending() && card.activeAttack.attacker.controller === context.source.controller && card.activeAttack.isAmbush,
