    ...
    public override setupCardAbilities(registrar: INonLeaderUnitAbilityRegistrar, AbilityHelper: IAbilityHelper) {
        registrar.addTriggeredAbility({
            ...
            when: {
                ...
                onCardAbilityInitiated: (event, context) => event.context.player === context.player && event.ability.isWhenDefeated && !event.context.manuallyActivated && event.context.event.name === EventName.OnCardDefeated
            },
