...
export enum EffectName {
    ...
    CanAttackBaseWhileUsingAmbush = 'canAttackBaseWhileUsingAmbush',
...
export enum Trait {
    ...
    Scarif = 'scarif',
    Seatos = 'seatos',
    SegraMilo = 'segra milo',
    Serenno = 'serenno',
    Sorgan = 'sorgan',
    StarkillerBase = 'starkiller base',
    StarlightBeacon = 'starlight beacon',
    StygeonPrime = 'stygeon prime',
    Takodana = 'takodana',
    Tatooine = 'tatooine',
    Utapau = 'utapau',
    Vardos = 'vardos',
