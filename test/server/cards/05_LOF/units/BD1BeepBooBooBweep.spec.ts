describe('BD-1, Beep Boo Boo Bweep', function() {
    integration(function(contextRef) {
        describe('BD-1\'s ability', function() {
            beforeEach(function() {
            ...
            it('gives another friendly unit +1/+0 and Saboteur until he leaves play', function () {
            ...
            it('gives another friendly unit +1/+0 and Saboteur until he leaves play, if he leaves immediately there is not ability remaining for the phase', function () {
                const { context } = contextRef;
