    ...
    integration(function (contextRef) {
        describe('Yaddle\'s on-attack ability', function () {
            ...
            it('should give Restore 1 to other friendly Jedi units for the phase', function () {
                ...
                expect(context.p1Base.damage).toBe(p1BaseDamage - 1); // only Restore 1, he should not have his ability boost
                ...
                // Luke should have Restore 4 damage
                ...
                // Battlefield Marine should not have Restore 1 any damage
