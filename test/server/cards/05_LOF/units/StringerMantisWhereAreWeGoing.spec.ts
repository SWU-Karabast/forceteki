describe('Stringer Mantis, Where are we Going ?', function() {
    integration(function(contextRef) {
        it('Stringer Mantis\'s ability may deal 2 damage to an exhausted unit', async function() {
            await contextRef.setupTestAsync({
                phase: 'action',
                player1: {
                    hand: ['stringer-mantis#where-are-we-going'],
            ...
            context.player1.clickCard(context.stringerMantis);
