    ...
    integration(function(contextRef) {
        describe('Kylo Ren\'s leader undeployed ability', function() {
            ...
            it('should discard a card from hand and give a unit +2/0 for this phase', function() {
                ...
                expect(context.getChatLogs(2)).toContain('player1 uses Kylo Ren, discarding Waylay and exhausting Kylo Ren to give +2/+0 to Death Star Stormtrooper for this phase');
