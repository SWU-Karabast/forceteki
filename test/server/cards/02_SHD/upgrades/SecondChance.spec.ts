    ...
    integration(function(contextRef) {
        describe('Second Chance\'s when defeated ability', function() {
            ...
            it('behaves correctly for more niche scenarios', function() {
                ...
                console.log('successfully attached second chance to death star stormtrooper');
                ...
                console.log('successfully attacked escort skiff');
                ...
                console.log('successfully attached second chance to swoop racer');

                expect(context.swoopRacer).toHaveExactUpgradeNames(['second-chance']);

                context.player2.clickCard(context.changeOfHeart);
                context.player2.clickCard(context.swoopRacer);
                console.log('successfully changed control of swoop racer');

                expect(context.swoopRacer).toHaveExactUpgradeNames(['second-chance']);

                context.player1.clickCard(context.escortSkiff);
                context.player1.clickCard(context.swoopRacer);
                console.log('successfully attacked swoop racer');
                ...
                console.log('swoop racer has been defeated');
