    ...
    integration(function(contextRef) {
        describe('Price on your Head\'s Bounty ability', function() {
            ...
            it('should not add the top deck card as a resource if deck is empty', function () {
                ...
                expect(context.player1).toHavePassAbilityPrompt('Bounty: Put the top card of your deck into play as a resource');
                context.player1.clickPrompt('Bounty: Put the top card of your deck into play as a resource');
