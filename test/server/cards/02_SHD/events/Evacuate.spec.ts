describe('Evacuate', function() {
    integration(function(contextRef) {
        it('returning all units cards, no leaders', function () {
        ...
        it('return all unit cards to hand and discard upgrades', function () {
            contextRef.setupTest({
                phase: 'action',
                player1: {
                    hand: ['evacuate'],
        ...
        it('return all unit cards to hand and discard upgrades and ignore deployed leaders', function () {
            contextRef.setupTest({
                phase: 'action',
                player1: {
                    hand: ['evacuate'],
