describe('Tech, Source of Insight', function () {
    integration(function (contextRef) {
        it('Tech\'s ability should give Smuggle to all cards in the resource zone', async function () {
            ...
            expect(context.getChatLogs(1)).toContain('player1 plays Tech from their resource row using Smuggle');
            ...
            expect(context.getChatLogs(1)).toContain('player1 plays Wampa from their resource row using Smuggle');
