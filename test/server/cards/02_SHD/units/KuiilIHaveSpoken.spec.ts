    ...
    integration(function (contextRef) {
        describe('Kuiil\'s ability', function () {
            ...
            it('should discard a card and only draw it if it shares an aspect with the base', function () {
                ...
                expect(context.player1).toHaveExactPromptButtons(['Discard a card from your deck. If it shares an aspect with your base, return it to your hand', 'Restore 1 (No effect)']);
                ...
                context.player1.clickPrompt('Discard a card from your deck. If it shares an aspect with your base, return it to your hand (No effect)');
                expect(context.player2).toBeActivePlayer();
            });
        });
    });
