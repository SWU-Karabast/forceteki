    ...
    integration(function (contextRef) {
        ...
        it('should shuffle resources', async function () {
            ...
            expect(context.getChatLogs(3)).toEqual([
                ...
                'player1 uses Scanning Officer to defeat a ready Reckless Gunslinger and an exhausted Armed to the Teeth from player2\'s resource row and to move 2 cards to player2\'s resources',
            ]);
        });
