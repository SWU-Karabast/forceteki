describe('In Defense of Kamino', function () {
    integration(function (contextRef) {
        describe('In Defense of Kamino\'s ability', function () {
            it('should give each friendly Republic unit Restore 2 and: "When Defeated: Create a Clone Trooper token."', function () {
