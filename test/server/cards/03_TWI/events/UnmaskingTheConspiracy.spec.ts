describe('Unmasking the Conspiracy', function() {
    integration(function(contextRef) {
        describe('Unmasking The Conspiracy\'s ability', function() {
            it('should prompt player to discard a random card to look at the opponent\'s hand and discard a card from it', function () {
