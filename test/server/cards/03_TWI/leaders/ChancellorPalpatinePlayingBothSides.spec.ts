        ...
        describe('Chancellor Palpatine\'s leader ability', function () {
            it('can flip back and forth', async function () {
                ...
                expect(context.getChatLogs(1)).toContain(
                    'player1 uses Chancellor Palpatine, exhausting Chancellor Palpatine to draw a card, then to heal 2 damage from their base, and then to flip Chancellor Palpatine'
                );
