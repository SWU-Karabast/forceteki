describe('No One Ever Knew', function() {
    integration(function(contextRef) {
        it('No One Ever Knew\'s ability should exhaust as many as we have Official unit (less than enemy units)', async function () {
        ...
        it('No One Ever Knew\'s ability should exhaust as many as we have Official unit (more than enemy units)', async function () {
            await contextRef.setupTestAsync({
                phase: 'action',
                player1: {
                    hand: ['no-one-ever-knew'],
