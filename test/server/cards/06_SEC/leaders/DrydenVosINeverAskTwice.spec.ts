describe('Dryden Vos, I Never Ask Twice', function () {
    integration(function (contextRef) {
        ...
        describe('Dryden Vos\'s undeployed ability', function() {
            it('must exhaust himself and discard a card which costs 6 or more to play a unit from hand which costs 5 or less and give it Ambush', async function () {
            ...
            it('must exhaust himself and discard a card which costs 6 or more to play a unit from hand which costs 5 or less and give it Ambush (no enough resources for some playable cards)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: 'dryden-vos#i-never-ask-twice',
            ...
            it('must exhaust himself and discard a card which costs 6 or more to play a unit from hand which costs 5 or less and give it Ambush (no enough resources for all playable cards)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: 'dryden-vos#i-never-ask-twice',
            ...
            it('must exhaust himself and discard a card which costs 6 or more to play a unit from hand which costs 5 or less and give it Ambush (nothing to Ambush)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: 'dryden-vos#i-never-ask-twice',
            ...
            it('should does nothing if there is no cards which costs 6 or more to discard', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: 'dryden-vos#i-never-ask-twice',
        ...
        describe('Dryden Vos\'s deployed ability', function() {
            it('must discard a card from hand to play a unit from hand and give it Ambush (no limit per turn)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
            ...
            it('must discard a card from hand to play a unit from hand and give it Ambush (nothing to Ambush)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: { card: 'dryden-vos#i-never-ask-twice', deployed: true },
            ...
            it('must discard a card from hand to play a unit from hand and give it Ambush (only 1 card to discard)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: { card: 'dryden-vos#i-never-ask-twice', deployed: true },
            ...
            it('must discard a card from hand to play a unit from hand and give it Ambush (can be used while exhausted)', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        leader: { card: 'dryden-vos#i-never-ask-twice', deployed: true },
            ...
            it('should does nothing if hand is empty', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
