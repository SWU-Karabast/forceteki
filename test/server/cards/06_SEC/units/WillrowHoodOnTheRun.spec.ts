describe('Willrow Hood On the Run', function () {
    integration(function (contextRef) {
        ...
        describe('Willrow Hood\'s ability with one friendly and one stollen upgrade', function () {
            beforeEach(async function() {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
            ...
            it('should allow Willrow Hood\'s upgrade to be defeated if he stole an enemy upgrade', function () {
                const { context } = contextRef;
