    ...
    integration(function(contextRef) {
        describe('Resupply\'s ability', function() {
            ...
            it('should put Resupply into play as a resource', function () {
                ...
                const readyResourcesBeforePlay = context.player1.countSpendableResources();
                ...
                expect(context.player1.resources.length).toBe(readyResourcesBeforePlay + 1);
                expect(context.player1.countSpendableResources()).toBe(readyResourcesBeforePlay - 3);
