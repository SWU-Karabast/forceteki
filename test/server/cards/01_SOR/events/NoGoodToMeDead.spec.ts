    ...
    integration(function(contextRef) {
        describe('No Good to Me Dead\'s ability', function() {
            it('should exhaust a unit and restrict it to be ready', async function () {
                ...
                expect(context.getChatLogs(1)).toContain('player1 plays No Good to Me Dead to exhaust Battlefield Marine and to apply a "cannot ready" restriction to Battlefield Marine for the rest of the round');
