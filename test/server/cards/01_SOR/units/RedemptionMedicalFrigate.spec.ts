    ...
    integration(function(contextRef) {
        it('Redemption\'s ability can heal up to 8 damages from units and base and deal damage to itself', async function () {
            ...
            expect(context.getChatLogs(2)).toEqual([
                'player1 uses Redemption to distribute 2 healing to Yoda, 1 healing to Han Solo, 1 healing to Alliance X-Wing, 1 healing to their base, 2 healing to player2\'s base, and 1 healing to AT-ST',
            ...
            expect(context.getChatLogs(2)).toEqual([
                'player1 uses Redemption to distribute 3 healing to Han Solo and 2 healing to their base',
