    ...
    integration(function (contextRef) {
        describe('Pantoran Starship Thief\'s when played ability', function () {
            ...
            it('allows to attach it to an enemy Fighter without a Pilot on it and take control of it', function () {
                ...
                expect(context.player1).toHavePassAbilityPrompt('Pay 3 resources to attach Pantoran Starship Thief as an upgrade to a Fighter or Transport unit without a Pilot on it. Take control of that unit');
