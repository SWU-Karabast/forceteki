describe('Nien Nunb Loyal Co-Pilot', function () {
    integration(function (contextRef) {
        describe('Nien Nunb Loyal Co-Pilot\'s ability', function () {
            it('should give +1/0 to himself for each other friendly Pilot upgrade and units', async function () {
            ...
            it('should give +1/0 to the attached unit for each other friendly Pilot upgrade and units when the unit has been stolen', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                    ...
                    player2: {
                        ...
                        groundArena: [{ card: 'reinforcement-walker', upgrades: ['iden-versio#adapt-or-die'] }, 'interceptor-ace'],
                        hasInitiative: true,
                    }
                });
