    ...
    integration(function (contextRef) {
        ...
        describe('Wedge Antilles\'s deployed ability', function () {
            it('should be able to deploy as a ground unit and have correct stats', async function () {
                ...
                context.player1.clickCard(context.wedgeAntilles);
                expect(context.player1).toHaveExactPromptButtons(['Cancel', '(No effect) Play a card from your hand using Piloting. It costs 1 resource less.', 'Deploy Wedge Antilles']);
            ...
            it('should reduce the cost of the next Pilot unit you play this phase by 1', async function () {
                ...
                context.player1.clickCard(context.wedgeAntilles);
                expect(context.player1).toHaveExactPromptButtons(['Cancel', 'Play a card from your hand using Piloting. It costs 1 resource less.', 'Deploy Wedge Antilles', 'Deploy Wedge Antilles as a Pilot']);
