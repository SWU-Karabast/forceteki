describe('Remote Scout', function () {
    integration(function (contextRef) {
        describe('Remote Scout\'s ability', function () {
            beforeEach(function () {
            ...
            it('should prompt to choose an Upgrade from the top 8 cards, reveal them, draw them, and move the rest to the bottom of the deck', function () {
                ...
                context.player1.clickCard(context.remoteScout);
                ...
                expect(context.getChatLog()).toContain('player1 uses Remote Scout to reveal and draw Devotion');
