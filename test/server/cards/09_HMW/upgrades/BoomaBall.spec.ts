describe('Booma Ball', function () {
    integration(function (contextRef) {
        describe('Booma Ball\'s ability', function() {
            it('should return an upgrade that costs 3 or less to its owner\'s hand', async function () {
                ...
                context.player2.clickCard(context.boomaBall);
                context.player2.clickCard(context.pykeSentinel);
                expect(context.player2).toBeAbleToSelectExactly([context.jediLightsaber, context.lukesLightsaber, context.boomaBall]);
            ...
            it('should defeat a token upgrade instead of returning to hand', async function () {
                ...
                context.player1.clickCard(context.boomaBall);
                context.player1.clickCard(context.pykeSentinel);
                expect(context.player1).toBeAbleToSelectExactly([context.entrenched, context.lukesLightsaber, context.experience, context.boomaBall]);
