describe('Ezra Bridger, Spectre Six', function() {
    integration(function(contextRef) {
        describe('Ezra\'s when played ability', function() {
            it('should heal 2 damage from a unit when no Aggression or Cunning unit is controlled', async function() {
                ...
                expect(context.player1).toHavePrompt('Heal 2 damage from a unit');
            ...
            it('should heal 4 damage from a unit when an Aggression unit is controlled', async function() {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        hand: ['ezra-bridger#spectre-six'],
            ...
            it('should heal 4 damage from a unit when a Cunning unit is controlled', async function() {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        hand: ['ezra-bridger#spectre-six'],
