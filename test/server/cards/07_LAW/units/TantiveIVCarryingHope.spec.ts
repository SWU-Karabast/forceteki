describe('Tantive IV, Carrying Hope', function () {
    integration(function (contextRef) {
        describe('Tantive IV\'s When Played ability', function () {
            it('should heal 4 from base if a friendly unit was defeated this phase', async function () {
            ...
            it('should not heal from base if no friendly unit was defeated this phase', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        hand: ['tantive-iv#carrying-hope'],
            ...
            it('should not heal from base if only an enemy unit was defeated this phase', async function () {
                await contextRef.setupTestAsync({
                    phase: 'action',
                    player1: {
                        hand: ['tantive-iv#carrying-hope'],
