describe('Boba Fett, For a Price', function () {
    integration(function (contextRef) {
        it('should deal 3 damage to a friendly ground unit when played', async function () {
        ...
        it('should deal 3 damage to itself when played', async function () {
            await contextRef.setupTestAsync({
                phase: 'action',
                player1: {
                    hand: ['boba-fett#for-a-price'],
            ...
            expect(context.snowspeeder.damage).toBe(0);
            expect(context.bobaFettForAPrice.damage).toBe(3);
            expect(context.strafingGunship.damage).toBe(0);
            expect(context.consularSecurityForce.damage).toBe(0);
            expect(context.ruthlessRaider.damage).toBe(0);
            expect(context.player1.readyResourceCount).toBe(1);
        ...
        it('should deal 3 damage to itself on attack', async function () {
            await contextRef.setupTestAsync({
                phase: 'action',
                player1: {
        ...
        it('should deal 3 damage to a friendly unit on attack', async function () {
            await contextRef.setupTestAsync({
                phase: 'action',
                player1: {
                    groundArena: ['snowspeeder', 'boba-fett#for-a-price'],
