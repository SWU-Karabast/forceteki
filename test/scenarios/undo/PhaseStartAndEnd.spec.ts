        ...
        describe('Effects at the start of the action phase,', function () {
            ...
            describe('after the effect prompt has finished,', function () {
                ...
                it('should not create a quick snapshot for the non-prompted player', function () {
                    ...
                    expect(contextRef.snapshot.getCurrentSnapshotId()).toEqual(context.regroupPhaseSnapshotId);
        ...
        describe('Effects at the end of the regroup phase,', function () {
            ...
            describe('after the effect prompt has finished,', function () {
                ...
                it('should not create a quick snapshot for the non-prompted player', function () {
                    ...
                    expect(contextRef.snapshot.getCurrentSnapshotId()).toEqual(context.resourceStepSnapshotId);
